...
def generate_launch_description():
    ...
    # Set the robots position and orientation
    x_robot_1 = '0.0'
    y_robot_1 = '0.0'
    yaw_robot_1 = '0.0'
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('hazard_topic_1', default_value='/robot_1/hazard_detection', description='Hazard topic for the robot 1.'),
        ...
        DeclareLaunchArgument('hazard_topic_2', default_value='/robot_2/hazard_detection', description='Hazard topic for the robot 2.'),
            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        'hazard_detection_topic': LaunchConfiguration('hazard_topic_1'),
            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        'hazard_detection_topic': LaunchConfiguration('hazard_topic_2'),
